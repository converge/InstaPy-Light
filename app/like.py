...
def check_link(browser,
    ...
    for dont_likes_regex in dont_like_regex:
        caught_word = re.search(dont_likes_regex, image_text, re.IGNORECASE)
        if caught_word:
            print('Inappropriate word found: {} ->'.format(caught_word))
...
def get_tags(browser, url):
    ...
    tags = re.findall(r'#\w*', image_text)
    return tags
